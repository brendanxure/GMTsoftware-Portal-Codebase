    ...
    <>
      <div className="container ">
        <div className="row display mt-3">
          {category.results &&
            category.results
              .filter((item) => item.category === "UI/UX")
              .map((item) => (
                <div
                  ...
                  key={item.pk}
                >
                  <img src={item.Image} className="card-img-top" alt="UI/UX" />
                  <div className="card-body">
                    ...
                    <div className="text-center">
                      ...
                      >
                        <Link
                          to="#"
                          className="t btn btn-dark btn-sm-center mx-3"
                        >
